...
| ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Purchase a new domain along with Whois Publicity                                          | [Purchase](../docs/purchase.md) | - \*service=**WhoisPublicity** \*                                                                                      |
...
| Purchase Whois Publicity for multiple domains in your account or sub-retail account \(Instant Purchase\)              | [AddBulkDomains](../docs/addbulkdomains.md) | - \*sldX=**first\_sld** \* - \*tldX=**first\_tld** \* - \*numyearsX=**first\_number\_of\_year** \* - \*producttype=**WhoisPublicity** \* - \*listcount=**total\_number\_of\_item** \* \*usecart=**false** \* |
| Purchase Whois Publicity for multiple domains in your account or sub-retail account \(Use Shopping Cart\)             | [AddBulkDomains](../docs/addbulkdomains.md) | - \*sldX=**first\_sld** \* - \*tldX=**first\_tld** \* - \*numyearsX=**first\_number\_of\_year** \* - \*producttype=**WhoisPublicity** \* - \*listcount=**total\_number\_of\_item** \* \*usecart=**true** \* |
